...
def memdump() :
	...
	memwindow.geometry("536x400+30+30")
	memwindow.resizable(0,0)
	mem_dump = Listbox(memwindow, height=24, width=65, font=('Courier', 10))
...
Label(topframe, text="Program:", width=38, font=('Courier', 10, 'bold'), anchor=W).pack(side=LEFT)
Label(topframe, text="Object code:", width=26, font=('Courier', 10, 'bold'), anchor=W).pack(side=LEFT)
Label(topframe, text="Symbol table:", width=20, font=('Courier', 10, 'bold'), anchor=W).pack(side=LEFT)
Label(topframe, text="Registers:", width=16, font=('Courier', 10, 'bold'), anchor=W).pack(side=LEFT)

asmxscrollbar = Scrollbar(middleframe, orient=HORIZONTAL)
asmyscrollbar = Scrollbar(middleframe)
textasm = Text(middleframe, wrap=NONE, xscrollcommand=asmxscrollbar.set, yscrollcommand=asmyscrollbar.set, height=10, width=36, font=('Courier', 10))
...
textdump = Listbox(middleframe, height=10, width=24, font=('Courier', 10))
...
textsym = Listbox(middleframe, height=10, width=16, font=('Courier', 10))
...
Label(middleframe, textvariable=root.cycle, width=25, font=('Courier', 10)).pack()
...
out = Text(bottomframe, height=8, width=122, font=('Courier', 10))
