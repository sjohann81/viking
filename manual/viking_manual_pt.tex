...
\pagestyle{empty}
\title{\textbf{Viking CPU - Manual de referência v0.2}}
...
Nos formatos de pseudo operações suportadas pelo montador e pseudo operações adicionais, o registrador \textit{r1} é exemplificado como registrador destino ou fonte da operação, enquanto \textit{r2} é fonte.
...
NEG  & Two's complement			& \texttt{neg r1} & \texttt{xor at,at,at\newline sub r1,at,r1} \\ \hline
...
\begin{itemize}
\item Comentários devem ser iniciados por um caracter ponto e vírgula (;) à esquerda, sem tabulações.
...
\chapter{Montador - código fonte}

\lstinputlisting[language=Python,caption=assemble16.py]{../assemble16.py}

\chapter{Simulador - código fonte}

\lstinputlisting[language=Python,caption=run16.py]{../run16.py}
